...
import com.example.proyectom07_izimoto.databinding.FragmentHabilitarFechaExamenBinding;

public class HabilitarFechaExamenFragment extends Fragment {


    private FragmentHabilitarFechaExamenBinding binding;
    private AppViewModel appViewModel;
    private NavController navController;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return (binding = FragmentHabilitarFechaExamenBinding.inflate(inflater, container, false)).getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.calendarView.setOnDaySelectedListener((startDay, endDay) -> {
            ...
            navController.navigate(R.id.action_habilitarFechaExamenFragment_to_confirmarFechaFragment);
